...
const translations = {
  en: {
    ...
    settings: {
      ...
      screenRecordingDesc: "Open macOS Settings and enable Screen Recording for KiraClaw if browser screenshots or screen capture features ask for permission.",
      screenRecordingGranted: "Granted",
      screenRecordingNotGranted: "Not Granted",
      screenRecordingUnknown: "Unknown",
      screenRecordingUnsupported: "macOS Only",
      screenRecordingGrantedStatus: "KiraClaw can already capture screen content on macOS.",
      screenRecordingUnknownStatus: "KiraClaw has not checked Screen Recording access yet.",
      screenRecordingUnsupportedStatus: "Screen Recording guidance is available on macOS only.",
    ...
    status: {
      ...
      openingScreenRecordingSettings: "Opening Screen Recording settings...",
      screenRecordingSettingsOpened: "Screen Recording settings opened.",
      screenRecordingSettingsFailed: "Failed to open Screen Recording settings: {{message}}",
  ...
  ko: {
    ...
    settings: {
      ...
      screenRecordingTitle: "화면 기록 권한",
      screenRecordingDesc: "브라우저 스크린샷이나 화면 캡처 기능에서 권한을 요구하면 macOS 설정에서 KiraClaw의 Screen Recording을 켜세요.",
      screenRecordingGranted: "허용됨",
      screenRecordingNotGranted: "허용 안 됨",
      screenRecordingUnknown: "확인 필요",
      screenRecordingUnsupported: "macOS 전용",
      screenRecordingGrantedStatus: "KiraClaw가 macOS 화면 콘텐츠를 이미 캡처할 수 있습니다.",
      screenRecordingUnknownStatus: "KiraClaw가 아직 Screen Recording 상태를 확인하지 못했습니다.",
      screenRecordingUnsupportedStatus: "Screen Recording 안내는 macOS에서만 제공됩니다.",
    ...
    status: {
      ...
      openingScreenRecordingSettings: "Screen Recording 설정 여는 중...",
      screenRecordingSettingsOpened: "Screen Recording 설정을 열었습니다.",
      screenRecordingSettingsFailed: "Screen Recording 설정 열기 실패: {{message}}",
